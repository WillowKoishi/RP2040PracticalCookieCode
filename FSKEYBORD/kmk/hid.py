...
HID_REPORT_SIZES = {
    HIDReportTypes.KEYBOARD: 100,
    HIDReportTypes.MOUSE: 40,
    HIDReportTypes.CONSUMER: 20,
    HIDReportTypes.SYSCONTROL: 80,  # TODO find the correct value for this
}
