...
RTIndex = 0
def mTimer():
    global dTime,RTIndex,tVList,mTimer
    if dTime >= 299:
        return
    dTime=dTime+1
...
while True:
    ...
    print("filted_dat:"+str(post_dat)+"   original_dat:"+str(v2t(ADC0.read_u16()*ADC_reference_voltage/65535)))
